...
void E30TTLUART_Config(uint16_t E30TTLUART_Address,uint8_t E30TTLUART_Channel, FunctionalState isAppointTargetSend);//配置模块
void E30TTLUART_TransparentSendBytesData(uint8_t *USART3_SendBuff, uint16_t DataSendLength);
